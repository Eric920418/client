    ...
    <div class=" mt-2" >
        <div class="card shadow-lg mb-5">
            ...
            <table class="table mt-3 table-sm  table-hover  table-borderless">
                <thead>
                <tr>
                    <th class="text-center" ref="thTime" style="width: 170px;" scope="col">時間<p class="text-danger m-0"></p></th>
                    ...
                    <tr v-for="(code, index) in code" :key="code._id"   >
                        <th ref="time" scope="row" >
                            <div class="d-flex flex-column align-items-center">
                                ...
                                <button class="btn btn-primary btn-sm" @click="goToDemo(this.beginCode[index])">Demo <i class="fas fa-play"></i></button>
                            </div>
                        </th>
                        <td class="sm " ref="html"><pre @mouseover="showCode('html')" @mouseleave="DontShowCode()"   v-html="code.html"></pre></td>
                        <td class="sm" ref="css" ><pre @mouseover="showCode('css')" @mouseleave="DontShowCode()" v-html="code.css"></pre></td>
                        <td class="sm" ref="js" ><pre @mouseover="showCode('js')" @mouseleave="DontShowCode()" v-html="code.js"></pre></td>
                    </tr>
                </tbody>
            </table>
        </div>
