...
<template>
  ...
  <div class="row login mx-0">
    ...
    <div
      class="position-absolute top-50 start-50 translate-middle col-md-6 px-3"
        ...
        <div class="form d-flex justify-content-center">
          <div style="width: 250px; height: 150px; margin-top: 55px">
            <div class="position-relative">
              <i
                class="bi bi-person-square position-absolute z-3 fs-5 text-black"
                style="top: 4px; right: 217px"
              ></i>
              <input
                class="d-flex form-control mb-2 position-relative ps-5"
                type="text"
                placeholder="學號"
                v-model="studentID"
              />
            ...
            <div class="position-relative">
              <i
                class="bi bi-lock-fill position-absolute z-3 fs-5 text-black"
                style="top: 4px; right: 217px"
              ></i>
              <input
                class="d-flex form-control mt-2 position-relative ps-5"
                type="password"
                placeholder="密碼"
                v-model="password"
                ref="pas"
              ...
              <i
                v-if="eye == false"
                class="bi bi-eye-fill position-absolute z-3 fs-5 text-black"
                style="top: 5px; right: 10px"
                @click="see"
              ></i>
              <i
                v-else-if="eye == true"
                class="bi bi-eye-slash-fill position-absolute z-3 fs-5 text-black"
                style="top: 5px; right: 10px"
                @click="see"
              ></i>
            </div>
            <div class="d-flex justify-content-center mt-2">
              <button class="btn btn-primary mt-2 w-25 me-3" @click="login">
                登入
              </button>
              <button
                class="btn btn-danger mt-2 w-25 ms-3"
                @click="status = false"
              >
                註冊
              </button>
        ...
        <div class="form d-flex justify-content-center">
          <div style="width: 300px; height: 150px; margin-top: 50px">
            <div class="position-relative d-flex">
              <i
                class="bi bi-person-vcard-fill position-absolute z-3 fs-5 text-black"
                style="top: 4px; right: 270px"
              ></i>
              <input
                class="d-flex form-control mb-2 position-relative ps-5"
                type="text"
            ...
            <div class="d-flex justify-content-center mt-2">
              <button class="btn btn-danger mt-2 w-25 me-3" @click="signup">
                註冊
              </button>
              <button
                class="btn btn-primary mt-2 w-50 ms-3 text-nowrap"
                @click="status = true"
              >
                返回登入
              </button>
