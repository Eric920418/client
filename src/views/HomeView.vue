            ...
            <div class="row">
              ...
              >
                ...
                >
                  ...
                  <div v-if="task.state + 1 == 6" style="font-size: 10px">
                    等待老師批改
                  </div>
...
export default {
  ...
  methods: {
    ...
    watchExm(index) {
      this.$swal.fire({
        title: "注意！！！",
        text: "各位同學實在非常抱歉，一直讓你們重新填寫，學長經驗不足能力不夠，導致頻繁出現Bug，目前存檔問題右下角那顆按鈕已經修復，如果擔心再次發生填完拍照起來，只要資料不見，照片給我我會負責幫你們填完，真的非常抱歉！",
        icon: "info",
      });
      // this.stopTimer();
      this.startTimer();
    ...
    backTask() {
      ...
      setTimeout(() => {
        ...
        this.$refs.formulate.classList.add("d-none");
        this.$refs.finish.classList.add("d-none");
        this.$refs.teacherCard.classList.add("d-none");
        this.$refs.todo.classList.add("d-none");
        this.$refs.nav.classList.add("d-none");
      }, 400);
      setTimeout(() => {
